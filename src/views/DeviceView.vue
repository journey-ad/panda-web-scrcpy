<script setup>
import { mdiArrowTopRight, mdiChevronDoubleLeft, mdiChevronDoubleRight, mdiConsole, mdiFolderMultipleOutline, mdiGithub, mdiInformationOutline, mdiPackageVariantClosed, mdiPower, mdiRocketLaunchOutline, mdiTextBoxSearchOutline } from '@mdi/js'
